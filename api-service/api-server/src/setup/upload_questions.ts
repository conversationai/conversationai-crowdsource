...
Uploads data to the questions table. The format of the input data is
newline delmited JSON (NDJSON).

Usage:

node build/server/setup/upload_questions.js \
...
ts-node src/setup/upload_questions.ts \
  --file="./tmp/foo.json" \
  --spanner_db="ptoxic" \
