...
import { ToxicitySubtypesJobComponent } from './toxicity_subtypes_job.component';
...
const appRoutes: Routes = [
  ...
  {
    path: 'toxicity_subtypes',
    component: ToxicitySubtypesJobComponent
  },
  {
    path: 'toxicity_subtypes/:customClientJobKey',
    component: ToxicitySubtypesJobComponent
  },
  {
    path: '',
